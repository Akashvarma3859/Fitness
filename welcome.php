...
<form method='post'  >
	...
	<p><input type="submit" name="bmrsubmit" class=" blue lighten-3 value="Get Result /></p>
...
<div class=paragraph>
 <p class=single>BMR(Basal Metabolic Rate) </p>
 <p>Your BMR is the amount of energy you expend each day when at rest. This Calculator allows you to calculate not only the number of calories you brun when inactive but also a daily calorie figure that take into account you lifestyle activity level. </p>
</form>
